...
tests/test_bot.py::TestHomework::test_check_response_empty PASSED        [ 94%]
tests/test_bot.py::TestHomework::test_api_response_timeout PASSED        [100%]

=================================== FAILURES ===================================
/app/homework.py:165: TypeError: Отсутствие TELEGRAM_TOKEN
/app/homework.py:121: KeyError: 0
/app/homework.py:104: Exception: отсутствие ожидаемых ключей в ответе API: dict
...
=================================== FAILURES ===================================
/app/homework.py:194: TypeError: Отсутствие PRACTICUM_TOKEN
/app/homework.py:150: KeyError: 0
=========================== short test summary info ============================
FAILED tests/test_bot.py::TestHomework::test_check_tokens_false - TypeError: ...
FAILED tests/test_bot.py::TestHomework::test_parse_status - KeyError: 0